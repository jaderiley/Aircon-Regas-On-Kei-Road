...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Aircon Regas on Kei Road",
    phone:     "+27 61 089 0897",
    whatsapp:  "+27 61 089 0897",
    address:   "1 Whitman St, Benoni, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Aircon Regas on Kei Road — Aircon & hvac in benoni",
    description: "Aircon Regas on Kei Road provides professional aircon & HVAC in Benoni. 4 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Aircon & HVAC · Benoni & surrounds",
    heroTitle:  "Stay cool, stay comfortable — <em>aircon done right.</em>",
    heroLead:   "Aircon Regas on Kei Road installs, repairs and services air conditioning and HVAC systems for homes and businesses across Benoni and the surrounding suburbs.",
    ...
    band: {
      ...
      alt:   "Aircon Regas on Kei Road team at work in Benoni",
      text:  "Keep your home or office comfortable all year round."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Benoni. Serving the surrounding area.",
    areasLead:  "We cover Benoni, Johannesburg, Randburg and the wider region for installations, repairs and servicing.",
